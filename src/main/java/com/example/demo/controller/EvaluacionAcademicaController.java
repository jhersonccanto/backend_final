...
@RestController
@RequestMapping("/api/evaluacion-academica")
...
public class EvaluacionAcademicaController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<EvaluacionAcademica> update(@PathVariable Long id, @Valid @RequestBody EvaluacionAcademica obj) {
